...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <h2 class="text-center">Welcome <?php echo $fname." ".$lname;?> - <a href="logout.php">Logout</a></h2>
                    <hr>
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <p>Start your morning off with this great recipe for hot coffee with coconut oil 
                    and butter.</p>
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <p>Sweetened with caramel sause and topped with Whipped cream, 
                    this will make you happy any time of day.</p>
